...
export const test = base.extend<TestFixtures>({
  ...
  productCartModule: async ({ headerSearchPage, searchResultsPage, productCartPage }, use) => {
    await use(new ProductCartModule(headerSearchPage, searchResultsPage, productCartPage));
  },
