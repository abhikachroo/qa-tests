...
import { SearchModule, LoginModule, AnonymousProductModule } from '@modules/index';
...
type TestFixtures = {
  ...
  anonymousProductModule: AnonymousProductModule;
  // Login fixtures
  loginPage:   LoginPage;
  homePage:    HomePage;
...
export const test = base.extend<TestFixtures>({
  ...
  anonymousProductModule: async ({ headerSearchPage, searchResultsPage, productDetailPage }, use) => {
    await use(new AnonymousProductModule(headerSearchPage, searchResultsPage, productDetailPage));
  },
