...
import { SearchModule, LoginModule, PurchaseModule } from '@modules/index';
...
export const test = base.extend<TestFixtures>({
  ...
  purchaseModule: async ({ productDetailPage, cartPage }, use) => {
    await use(new PurchaseModule(productDetailPage, cartPage));
  },
});
